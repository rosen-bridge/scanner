...
describe('cardanoBlockFrostObservationExtractor', () => {
  beforeEach(async () => {
    dataSource = await createDatabase();
  });
  describe('processTransactionsCardano', () => {
    /**
     * @target cardanoBlockFrostObservationExtractor.processTransactionsCardano
    ...
    it('should return true and insert observation into database on valid lock tx', async () => {
      ...
      const txHash = validLockTx.utxos.hash;
