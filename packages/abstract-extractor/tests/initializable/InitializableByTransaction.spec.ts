...
import { MockedInitializableByTxErgoExtractor } from './InitializableByTransaction.mock';
...
describe('AbstractInitializableByTransactionErgoExtractor', () => {
  describe('getTotalTxCount', () => {
    ...
    it('should return the total tx count', async () => {
      const extractor = new MockedInitializableByTxErgoExtractor(
