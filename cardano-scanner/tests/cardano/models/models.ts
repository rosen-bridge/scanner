...
import { NetworkDataBase } from "../../../lib/models/networkModel";
import { Observation } from "../../../lib/objects/interfaces";
    ...
    describe("getLastSavedBlock", () => {
        it("should return last saved block", async () => {
            ...
            expect(lastBlock).to.eql({
                ...
                "parent_hash": "26197be6579e09c7edec903239866fbe7ff6aee2e4ed4031c64d242e9dd1bff6",
