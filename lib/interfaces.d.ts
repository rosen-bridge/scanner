...
declare abstract class AbstractDataBase<DataT> {
    /**
...
declare abstract class AbstractNetworkConnector<TransactionType> {
    /**
...
declare abstract class AbstractExtractor<TransactionType> {
    /**
